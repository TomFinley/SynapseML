...
@inherit_doc
class TextSentimentSDK(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    includeOpinionMining = Param(Params._dummy(), "includeOpinionMining", "ServiceParam: includeOpinionMining option")
    ...
    def __init__(
        ...
        errorCol="Error",
        includeOpinionMining=None,
        includeOpinionMiningCol=None,
        ...
        super(TextSentimentSDK, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.TextSentimentSDK", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.TextSentimentSDK"

    @staticmethod
    def _from_java(java_stage):
        module_name=TextSentimentSDK.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".TextSentimentSDK"
    ...
    def setIncludeOpinionMining(self, value):
        """
        Args:
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setIncludeOpinionMining(value)
        return self
    
    def setIncludeOpinionMiningCol(self, value):
        """
        Args:
            includeOpinionMining: includeOpinionMining option
        """
        self._java_obj = self._java_obj.setIncludeOpinionMiningCol(value)
        return self
    ...
    def getIncludeOpinionMining(self):
        """
        Returns:
            includeOpinionMining: includeOpinionMining option
        """
        return self._java_obj.getIncludeOpinionMining()
