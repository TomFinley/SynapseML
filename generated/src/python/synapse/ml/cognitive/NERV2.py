...
@inherit_doc
class NERV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(NERV2, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.NERV2", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.NERV2"

    @staticmethod
    def _from_java(java_stage):
        module_name=NERV2.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".NERV2"
