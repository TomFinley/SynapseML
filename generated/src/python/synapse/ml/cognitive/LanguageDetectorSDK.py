...
@inherit_doc
class LanguageDetectorSDK(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(LanguageDetectorSDK, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.LanguageDetectorSDK", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.LanguageDetectorSDK"

    @staticmethod
    def _from_java(java_stage):
        module_name=LanguageDetectorSDK.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".LanguageDetectorSDK"
