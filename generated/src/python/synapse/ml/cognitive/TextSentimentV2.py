...
@inherit_doc
class TextSentimentV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(TextSentimentV2, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.TextSentimentV2", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.TextSentimentV2"

    @staticmethod
    def _from_java(java_stage):
        module_name=TextSentimentV2.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".TextSentimentV2"
