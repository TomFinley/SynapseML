...
@inherit_doc
class NERSDK(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(NERSDK, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.NERSDK", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.NERSDK"

    @staticmethod
    def _from_java(java_stage):
        module_name=NERSDK.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".NERSDK"
