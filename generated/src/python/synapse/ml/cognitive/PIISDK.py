...
@inherit_doc
class PIISDK(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(PIISDK, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.PIISDK", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.PIISDK"

    @staticmethod
    def _from_java(java_stage):
        module_name=PIISDK.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".PIISDK"
