...
class TrainedClassifierModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    levels = Param(Params._dummy(), "levels", "the levels")
    ...
    def __init__(
        ...
        super(TrainedClassifierModel, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.train.TrainedClassifierModel", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.train.TrainedClassifierModel"
