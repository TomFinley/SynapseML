...
class DropColumns(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    cols = Param(Params._dummy(), "cols", "Comma separated list of column names", typeConverter=TypeConverters.toListString)
    ...
    def __init__(
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.stages.DropColumns", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.stages.DropColumns"
