...
class Cacher(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    disable = Param(Params._dummy(), "disable", "Whether or disable caching (so that you can turn it off during evaluation)", typeConverter=TypeConverters.toBoolean)
    ...
    def __init__(
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.stages.Cacher", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.stages.Cacher"
