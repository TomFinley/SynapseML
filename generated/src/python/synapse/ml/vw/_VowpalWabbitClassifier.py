...
class _VowpalWabbitClassifier(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        labelConversion (bool): Convert 0/1 Spark ML style labels to -1/1 VW style labels. Defaults to true.
    ...
    labelConversion = Param(Params._dummy(), "labelConversion", "Convert 0/1 Spark ML style labels to -1/1 VW style labels. Defaults to true.", typeConverter=TypeConverters.toBoolean)
