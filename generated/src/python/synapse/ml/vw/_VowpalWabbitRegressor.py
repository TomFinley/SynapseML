...
class _VowpalWabbitRegressor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.vw.VowpalWabbitRegressor", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.vw.VowpalWabbitRegressor"
    ...
    def _create_model(self, java_model):
        try:
            model = VowpalWabbitRegressionModel(java_obj=java_model)
            model._transfer_params_from_java()
        except TypeError:
            model = VowpalWabbitRegressionModel._from_java(java_model)
        return model
