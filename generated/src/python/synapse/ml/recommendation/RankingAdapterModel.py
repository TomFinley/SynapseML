...
class RankingAdapterModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    recommenderModel = Param(Params._dummy(), "recommenderModel", "recommenderModel")
    ...
    def __init__(
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.recommendation.RankingAdapterModel", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.recommendation.RankingAdapterModel"
    ...
    def getRecommenderModel(self):
        ...
        Returns:
            recommenderModel: recommenderModel
        """
        return JavaParams._from_java(self._java_obj.getRecommenderModel())
