...
from synapse.ml.lightgbm.LightGBMRegressionModel import LightGBMRegressionModel
...
class LightGBMRegressor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    alpha = Param(Params._dummy(), "alpha", "parameter for Huber loss and Quantile regression", typeConverter=TypeConverters.toFloat)
    ...
    executionMode = Param(Params._dummy(), "executionMode", "Specify how LightGBM is executed.  Values can be streaming, bulk. Default is bulk.", typeConverter=TypeConverters.toString)
    ...
    passThroughArgs = Param(Params._dummy(), "passThroughArgs", "Direct string to pass through to LightGBM library (appended with other explicitly set params). Will override any parameters given with explicit setters. Can include multiple parameters in one string.", typeConverter=TypeConverters.toString)
    ...
    tweedieVariancePower = Param(Params._dummy(), "tweedieVariancePower", "control the variance of tweedie distribution, must be between 1 and 2", typeConverter=TypeConverters.toFloat)
    ...
    def __init__(
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.lightgbm.LightGBMRegressor", self.uid)
        else:
        ...
        self._setDefault(executionMode="bulk")
        ...
        self._setDefault(microBatchSize=1)
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.lightgbm.LightGBMRegressor"
    ...
    def _create_model(self, java_model):
        try:
            model = LightGBMRegressionModel(java_obj=java_model)
            model._transfer_params_from_java()
        except TypeError:
            model = LightGBMRegressionModel._from_java(java_model)
        return model
