...
#' @param tokensCol The column holding the tokens
#' @export

ml_text_shap <- function(
    x,
    infWeight=1.0E+8,
    inputCol=NULL,
    metricsCol="r2",
    ...
    tokensCol="tokens",
    only.model=FALSE,
    uid=random_string("ml_text_shap"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.explainers.TextSHAP"
