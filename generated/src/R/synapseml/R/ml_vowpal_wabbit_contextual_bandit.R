...
#' @param chosenActionCol Column name of chosen action
#' @param epsilon epsilon used for exploration
...
#' @param probabilityCol Column name of probability of chosen action
...
ml_vowpal_wabbit_contextual_bandit <- function(
    x,
    ...
    unfit.model=FALSE,
    only.model=FALSE,
    uid=random_string("ml_vowpal_wabbit_contextual_bandit"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.vw.VowpalWabbitContextualBandit"
    ...
    mod_parameterized <- mod %>%
        ...
        invoke("setChosenActionCol", chosenActionCol) %>%
    ...
    transformer <- mod_parameterized %>%
        invoke("fit", df)
    scala_transformer_class <- "com.microsoft.azure.synapse.ml.vw.VowpalWabbitContextualBanditModel"
    if (only.model)
