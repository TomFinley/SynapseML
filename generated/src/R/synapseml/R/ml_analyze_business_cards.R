...
ml_analyze_business_cards <- function(
    x,
    backoffs=c(100,500,1000),
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="AnalyzeBusinessCards_371ccec85819_error",
    imageBytes=NULL,
    imageBytesCol=NULL,
    imageUrl=NULL,
    imageUrlCol=NULL,
    ...
    outputCol="AnalyzeBusinessCards_371ccec85819_output",
    pages=NULL,
    pagesCol=NULL,
    pollingDelay=300,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_analyze_business_cards"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.AnalyzeBusinessCards"
