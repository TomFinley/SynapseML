...
ml_language_detector_v2 <- function(
    x,
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="LanguageDetectorV2_5c9de7f8a4cc_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    outputCol="LanguageDetectorV2_5c9de7f8a4cc_output",
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_language_detector_v2"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.LanguageDetectorV2"
