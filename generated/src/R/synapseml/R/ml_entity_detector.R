...
ml_entity_detector <- function(
    ...
    errorCol="EntityDetector_a9c4ed033225_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    modelVersion=NULL,
    modelVersionCol=NULL,
    outputCol="EntityDetector_a9c4ed033225_output",
    showStats=NULL,
    showStatsCol=NULL,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_entity_detector"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.EntityDetector"
