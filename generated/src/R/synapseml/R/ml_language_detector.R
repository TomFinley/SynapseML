...
ml_language_detector <- function(
    ...
    errorCol="LanguageDetector_8020b6e91aeb_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    modelVersion=NULL,
    modelVersionCol=NULL,
    outputCol="LanguageDetector_8020b6e91aeb_output",
    showStats=NULL,
    showStatsCol=NULL,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_language_detector"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.LanguageDetector"
