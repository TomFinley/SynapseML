...
ml_detect_last_anomaly <- function(
    ...
    errorCol="DetectLastAnomaly_a9917b6a24bc_error",
    granularity=NULL,
    granularityCol=NULL,
    handler=NULL,
    ...
    outputCol="DetectLastAnomaly_a9917b6a24bc_output",
    period=NULL,
    periodCol=NULL,
    sensitivity=NULL,
    sensitivityCol=NULL,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_detect_last_anomaly"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.DetectLastAnomaly"
