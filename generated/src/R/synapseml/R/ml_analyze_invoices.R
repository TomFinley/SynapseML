...
ml_analyze_invoices <- function(
    x,
    backoffs=c(100,500,1000),
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="AnalyzeInvoices_ccce57c794eb_error",
    imageBytes=NULL,
    imageBytesCol=NULL,
    imageUrl=NULL,
    imageUrlCol=NULL,
    ...
    outputCol="AnalyzeInvoices_ccce57c794eb_output",
    pages=NULL,
    pagesCol=NULL,
    pollingDelay=300,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_analyze_invoices"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.AnalyzeInvoices"
