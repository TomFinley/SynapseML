...
ml_analyze_id_documents <- function(
    x,
    backoffs=c(100,500,1000),
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="AnalyzeIDDocuments_6aecb1782d23_error",
    imageBytes=NULL,
    imageBytesCol=NULL,
    imageUrl=NULL,
    imageUrlCol=NULL,
    ...
    outputCol="AnalyzeIDDocuments_6aecb1782d23_output",
    pages=NULL,
    pagesCol=NULL,
    pollingDelay=300,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_analyze_id_documents"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.AnalyzeIDDocuments"
