...
ml_nerv2 <- function(
    ...
    errorCol="NERV2_f8fc1be53f9b_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    outputCol="NERV2_f8fc1be53f9b_output",
    ...
    ...)
{
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.NERV2"
