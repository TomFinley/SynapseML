...
#' @param groupbyCol column that groups the series
...
#' @param timestampCol column representing the time of the series
#' @param url Url of the service
#' @param valueCol column representing the value of the series
#' @export

ml_simple_detect_anomalies <- function(
    x,
    concurrency=1,
    concurrentTimeout=NULL,
    customInterval=NULL,
    customIntervalCol=NULL,
    errorCol="SimpleDetectAnomalies_72f9b78dca75_error",
    granularity=NULL,
    granularityCol=NULL,
    groupbyCol=NULL,
    handler=NULL,
    ...
    outputCol="SimpleDetectAnomalies_72f9b78dca75_output",
    period=NULL,
    periodCol=NULL,
    sensitivity=NULL,
    sensitivityCol=NULL,
    ...
    valueCol="value",
    only.model=FALSE,
    uid=random_string("ml_simple_detect_anomalies"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.SimpleDetectAnomalies"
    ...
    mod_parameterized <- mod %>%
        ...
        invoke("setGroupbyCol", groupbyCol) %>%
