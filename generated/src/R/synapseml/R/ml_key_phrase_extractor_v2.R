...
ml_key_phrase_extractor_v2 <- function(
    x,
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="KeyPhraseExtractorV2_e331e5da5d43_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    outputCol="KeyPhraseExtractorV2_e331e5da5d43_output",
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_key_phrase_extractor_v2"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.KeyPhraseExtractorV2"
