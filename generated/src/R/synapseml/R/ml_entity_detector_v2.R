...
ml_entity_detector_v2 <- function(
    x,
    concurrency=1,
    concurrentTimeout=NULL,
    errorCol="EntityDetectorV2_5f259f4eccf1_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    outputCol="EntityDetectorV2_5f259f4eccf1_output",
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_entity_detector_v2"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.EntityDetectorV2"
