...
ml_key_phrase_extractor_sdk <- function(
    x,
    batchSize=5,
    concurrency=1,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_key_phrase_extractor_sdk"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.KeyPhraseExtractorSDK"
