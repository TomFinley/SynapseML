...
ml_key_phrase_extractor <- function(
    ...
    errorCol="KeyPhraseExtractor_4a9e3aadb744_error",
    handler=NULL,
    language=NULL,
    languageCol=NULL,
    modelVersion=NULL,
    modelVersionCol=NULL,
    outputCol="KeyPhraseExtractor_4a9e3aadb744_output",
    showStats=NULL,
    showStatsCol=NULL,
    ...
    url=NULL,
    only.model=FALSE,
    uid=random_string("ml_key_phrase_extractor"),
    ...)
{
    if (unfit.model) {
        sc <- x
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.cognitive.KeyPhraseExtractor"
