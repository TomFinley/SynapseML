    ...
    ...)
{
    ...
    scala_class <- "com.microsoft.azure.synapse.ml.recommendation.SAR"
    ...
    transformer <- mod_parameterized %>%
        invoke("fit", df)
    scala_transformer_class <- "com.microsoft.azure.synapse.ml.recommendation.SARModel"
    if (only.model)
