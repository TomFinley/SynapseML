...
namespace Synapse.ML.Recommendation
{
    ...
    public class RankingTrainValidationSplit : JavaEstimator<RankingTrainValidationSplitModel>, IJavaMLWritable, IJavaMLReadable<RankingTrainValidationSplit>
    {
        ...
        /// </summary>
        /// <param name="value">
        /// ratio between training set and validation set (>= 0 and <= 1)
        /// </param>
        /// <returns> New RankingTrainValidationSplit object </returns>
        ...
        {
            var jvmObject = (JvmObjectReference)Reference.Invoke("getEstimator");
        ...
        {
            var jvmObjects = (JvmObjectReference[])Reference.Invoke("getEstimatorParamMaps");
        ...
        {
            var jvmObject = (JvmObjectReference)Reference.Invoke("getEvaluator");
            Dictionary<string, Type> classMapping = JvmObjectUtils.ConstructJavaClassMapping(
        ...
        /// </summary>
        /// <returns>an <see cref="JavaMLReader&lt;RankingTrainValidationSplit&gt;"/> instance for this ML instance.</returns>
