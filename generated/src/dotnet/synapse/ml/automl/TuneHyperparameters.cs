...
namespace Synapse.ML.Automl
{
    ...
    public class TuneHyperparameters : JavaEstimator<TuneHyperparametersModel>, IJavaMLWritable, IJavaMLReadable<TuneHyperparameters>
    {
        ...
        public TuneHyperparameters SetModels(IEstimator<object>[] value)
            => WrapAsTuneHyperparameters(Reference.Invoke("setModels", (object)value.ToJavaArrayList()));
        ...
        public TuneHyperparameters SetParamSpace(object value) =>
            WrapAsTuneHyperparameters(Reference.Invoke("setParamSpace", (object)value));
        ...
        {
            var jvmObjects = (JvmObjectReference[])Reference.Invoke("getModels");
            var result = new IEstimator<object>[jvmObjects.Length];
        ...
        /// </summary>
        /// <returns>an <see cref="JavaMLReader&lt;TuneHyperparameters&gt;"/> instance for this ML instance.</returns>
