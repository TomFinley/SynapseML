...
namespace Synapse.ML.Automl
{
    ...
    public class FindBestModel : JavaEstimator<BestModel>, IJavaMLWritable, IJavaMLReadable<FindBestModel>
    {
        ...
        public FindBestModel SetModels(JavaTransformer[] value)
            => WrapAsFindBestModel(Reference.Invoke("setModels", (object)value.ToJavaArrayList()));
        /// <summary>
        ...
        public JavaTransformer[] GetModels()
        {
            ...
            var result = new JavaTransformer[jvmObjects.Length];
        ...
        /// </summary>
        /// <returns>an <see cref="JavaMLReader&lt;FindBestModel&gt;"/> instance for this ML instance.</returns>
