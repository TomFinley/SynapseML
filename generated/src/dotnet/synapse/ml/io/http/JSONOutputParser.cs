...
namespace Synapse.ML.Io.Http
{
    ...
    public class JSONOutputParser : JavaTransformer, IJavaMLWritable, IJavaMLReadable<JSONOutputParser>
    {
        ...
        {
            var jvmObject = (JvmObjectReference)Reference.Invoke("getDataType");
        ...
        {
            var jvmObject = (JvmObjectReference)Reference.Invoke("getPostProcessor");
        ...
        /// </summary>
        /// <returns>an <see cref="JavaMLReader&lt;JSONOutputParser&gt;"/> instance for this ML instance.</returns>
