...
namespace Synapse.ML.Stages
{
    ...
    public class MultiColumnAdapter : JavaEstimator<PipelineModel>, IJavaMLWritable, IJavaMLReadable<MultiColumnAdapter>
    {
        ...
        {
            var jvmObject = (JvmObjectReference)Reference.Invoke("getBaseStage");
        ...
        /// </summary>
        /// <returns>an <see cref="JavaMLReader&lt;MultiColumnAdapter&gt;"/> instance for this ML instance.</returns>
